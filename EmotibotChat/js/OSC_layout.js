...
$(function() {
   ...
   var dates21 = $( "#from21, #to21" ).datepicker({
      maxDate: new Date(),
      defaultDate: "+1w",
      changeMonth: true,
      changeYear: true,
      numberOfMonths: 1,
      onSelect: function( selectedDate ) {
         var option = this.id == "from21" ? "minDate" : "maxDate",
            instance = $( this ).data( "datepicker" ),
            date1 = $.datepicker.parseDate(
               instance.settings.dateFormat ||
               $.datepicker._defaults.dateFormat,
   ...
   var dates22 = $( "#from22, #to22" ).datepicker({
      maxDate: new Date(),
      defaultDate: "+1w",
      changeMonth: true,
      changeYear: true,
      numberOfMonths: 1,
      onSelect: function( selectedDate ) {
         var option = this.id == "from22" ? "minDate" : "maxDate",
            instance = $( this ).data( "datepicker" ),
            date1 = $.datepicker.parseDate(
               instance.settings.dateFormat ||
               $.datepicker._defaults.dateFormat,
   ...
   var dates23 = $( "#from23, #to23" ).datepicker({
      maxDate: new Date(),
      defaultDate: "+1w",
      changeMonth: true,
      changeYear: true,
      numberOfMonths: 1,
      onSelect: function( selectedDate ) {
         var option = this.id == "from23" ? "minDate" : "maxDate",
            instance = $( this ).data( "datepicker" ),
            date23 = $.datepicker.parseDate(
               instance.settings.dateFormat ||
               $.datepicker._defaults.dateFormat,
               selectedDate, instance.settings );
         dates23.not( this ).datepicker( "option", option, date23 );
      }
   });
	
   var dates24 = $( "#from24, #to24" ).datepicker({
      maxDate: new Date(),
      defaultDate: "+1w",
      changeMonth: true,
      changeYear: true,
      numberOfMonths: 1,
      onSelect: function( selectedDate ) {
         var option = this.id == "from24" ? "minDate" : "maxDate",
            instance = $( this ).data( "datepicker" ),
            date24 = $.datepicker.parseDate(
               instance.settings.dateFormat ||
               $.datepicker._defaults.dateFormat,
               selectedDate, instance.settings );
         dates24.not( this ).datepicker( "option", option, date24 );
      }
   });
   
   var dates25 = $( "#from25, #to25" ).datepicker({
      maxDate: new Date(),
      defaultDate: "+1w",
      changeMonth: true,
      changeYear: true,
      numberOfMonths: 1,
      onSelect: function( selectedDate ) {
         var option = this.id == "from25" ? "minDate" : "maxDate",
            instance = $( this ).data( "datepicker" ),
            date25 = $.datepicker.parseDate(
               instance.settings.dateFormat ||
               $.datepicker._defaults.dateFormat,
               selectedDate, instance.settings );
         dates25.not( this ).datepicker( "option", option, date25 );
      }
   });
});

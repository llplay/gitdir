      ...
      <div class="wrapper-page animated fadeInDown">
         <div class="panel panel-color panel-primary">
            <div class="panel-heading"> 
               <h3 class="text-center m-t-10"> 竹间对话 - 机器人 </strong> </h3>
            </div>
            <form name=myForm method=POST  class="form-horizontal m-t-40" action=robotLogin.php>                                
               <div class="form-group ">
                  <div class="col-xs-12"> 
                  <td>用户名：</td>
                  <td><label>
                   <input class="form-control" type="text" name=login_name placeholder="用户名"></label></td>
                  </div>
               </div>
               <div class="form-group ">
                  <div class="col-xs-12">
                  <td> QQ 号：</td>
                  <td><label>
                     <input class="form-control" type="text" name=qqnumber placeholder="QQ号"></label></td>
                  </div>
               </div>
               <div class="form-group ">
                  <div class="col-xs-12">
	             <div id="msg" class="msg" style="display:none;">错误--输入用户名或QQ号错误，请重新输入</div>    
                  </div>
               </div>

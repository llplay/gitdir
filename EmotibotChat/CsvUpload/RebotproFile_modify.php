<?php
   ...
   if ($cmd == "read") // Load
   {
      $str_select = "Select * from rebotprofile where RFId=$RFId";
   ...
   else if ($RFId == 0) // Insert
   {
      $strQ = $_GET["strQ"];
      $strA = $_GET["strA"];
      $str_insert = "Insert into rebotprofile (strQ, strA,Status)" 
                  . " VALUES('$strQ','$strA',1)" ;
   ...
   else // Update
   {
      $strQ = $_GET["strQ"];
      $strA = $_GET["strA"];
      $str_update = "Update rebotprofile set strQ='$strQ', strA='$strA' where RFId=$RFId";
...
<html>
   <head>
      ...
      <Script Language=JavaScript>
         ...
         function modifyRebotproFileContent(RFId)
         {
...
?>       
                           <tr>
                              <th colspan="4" class="submitBtns">
                                 <a class="btn_submit_new modifyRebotproFileContent"><input name="modifyRebotproFileButton" type="button" value="保存" OnClick="modifyRebotproFileContent(<?php echo $RFId;?>)"></a>
                              </th>
                           </tr>      
<?php
   }

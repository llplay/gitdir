      ...
      <div class="wrapper-page animated fadeInDown">
         <div class="panel panel-color panel-primary">
            <div class="panel-heading"> 
               <h3 class="text-center m-t-10"> 竹间对话 - 管理者 </strong> </h3>
            </div>
            <form name=myForm method=POST  class="form-horizontal m-t-40" action=adminLogin.php>                                
               ...
               <div class="form-group ">
                  <div class="col-xs-12">
	             <div id="msg" class="msg" style="display:none;">错误--用户名或QQ号错误，请重新输入</div>    
                  </div>
               </div>

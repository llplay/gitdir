<?php
   ...
   if ($_SESSION["QQ"] == "" || $_SESSION["username"] == "")
   {
      session_write_close();
      sleep(DELAY_SEC);
      header("Location:userMain.php?cmd=main");
      exit();
   }
...
<?php
   echo "<li id=0 class='active'><a href='javascript:void(0)'><span class='tabIcon QQ'></span><span class='nav-label'>Topic选择</span></a></li>";
?>
                     </ul>
                  </li>
               </ul>
...
<?php
   ...
   include("Topics_user/Topics_user_list.php");
   echo "</div>";
?>
            </div>
         </div>

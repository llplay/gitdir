<script type="text/javascript">
   ...
   function expandSearchUsersContentFunc() {
   ...
   function actionSearchUsers(UserId, Status) {
      ...
      url_str = "Users/Users_action.php?";
...
<!--新增修改所跳出的 block 开始-->
<div id="searchUsersContent" class="blockUI" style="display:none;"></div>
<!--新增修改所跳出的 block 结束-->
   ...
   <form>
      <table class="searchField" border="0" cellspacing="0" cellpadding="0">
         <tr>
            <th>姓名：</th>
            <td>
            <input id="searchUsersName" type="text" maxlength="50">
        <!-- </td>
            <th>状态 ：</th>
            <td colspan="3"><label>
               <input id="searchUsersCheckBox1" type="checkbox" checked>
               上架</label><label>
               <input id="searchUsersCheckBox2" type="checkbox" checked>
               下架</label></td>  -->
         </tr>
         <tr>
            <th colspan="4" class="submitBtns"><a class="btn_submit_new searchUsers">
            <input name="searchUsersButton" type="button" value="开始查询">
            </a></th>
         </tr>
      </table>
   </form>
